...
\end{scriptsize}
\centering
%\includegraphics[width=.64\linewidth]example401.jpg}
  \end{column}
  \begin{column}{.5\textwidth}
  \begin{scriptsize}
\begin{verbatim}
...
\end{scriptsize}
\centering
%  \includegraphics[width=.64\linewidth]{example402.jpg}
  \end{column}
\end{columns}
...
\end{scriptsize}
\centering
%\includegraphics[width=.64\linewidth]{example403.jpg}
  \end{column}
  \begin{column}{.5\textwidth}
  \begin{scriptsize}
\begin{verbatim}
...
\end{scriptsize}
\centering
%  \includegraphics[width=.64\linewidth]{example404.jpg}
  \end{column}
\end{columns}
...
\end{scriptsize}
\centering
%\includegraphics[width=.64\linewidth]{example405.jpg}
  \end{column}
  \begin{column}{.5\textwidth}
  \begin{scriptsize}
\begin{verbatim}
...
\end{scriptsize}
\centering
%  \includegraphics[width=.64\linewidth]{example406.jpg}
  \end{column}
\end{columns}
...
\centering
%  \includegraphics[width=.64\linewidth]{example407.jpg}
  \end{column}
\end{columns}
...
\centering
%  \includegraphics[width=.64\linewidth]{example408.jpg}
  \end{column}
\end{columns}
